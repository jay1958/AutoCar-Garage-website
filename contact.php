        ...
        <div class="row">
          <div class="col-md-8">
            ...
            <form id="contactForm" name="contact">
                ...
                <div class="row form-group">
                    <div class="col-md-12">
                      <input type="text" id="subject" name="subject" class="form-control subject" maxlength="100" placeholder="Model*">
                      <label class="err_subject" style="color: red;margin-left: 0.7pc;display: none;"> Please enter your Model </label>
                    </div>
                </div>
                <div class="row form-group">
                  <div class="col-md-12">
          ...
          <div class="col-md-4">
				<br>
                <h4 class="text-muted">Contact Info</h4><br>
                
                <ul>
                  <li><i class="fa fa-map-marker"></i> <p><strong>Address</strong> At:Auto Car Garage, Dungri Dist:Valsad</p></li>
                  <li><i class="fa fa-user"></i> <p><strong>Phone</strong>: (+91)7096481958</p></li>
